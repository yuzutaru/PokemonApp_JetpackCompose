...
class UpdateUserProfileUseCaseTest {
    ...
    @Test
    fun `when invoke is called, verify repository updateUserProfile is called with correct parameters`() =
        runTest {
            // Given
    ...
    @Test
    fun `when invoke is called with null values, verify repository updateUserProfile is called with nulls`() =
        runTest {
            // Given
            val username = "testUser"
